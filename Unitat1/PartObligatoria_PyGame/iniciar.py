...
pygame.mixer.music.load(os.path.join(resources, "Apoxode_-_Electric_1.wav"))
pygame.mixer.music.play(loops=-1)
pygame.mixer.music.set_volume(0.2)

move_up_sound = pygame.mixer.Sound(os.path.join(resources, "Rising_putter.wav"))
move_down_sound = pygame.mixer.Sound(os.path.join(resources, "Falling_putter.wav"))
